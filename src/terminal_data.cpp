...
TerminalData::Line& TerminalData::InsertLine(int aIndex)
{
	assert(!mReadOnly);
...
void TerminalData::InputGlyph(TerminalData::Line& aLine, int& aColumnIndex, TerminalData::PaletteIndex aPaletteIndex, uint8_t aValue) {
